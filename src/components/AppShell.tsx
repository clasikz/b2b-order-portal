      ...
      <aside className="hidden w-60 shrink-0 flex-col bg-navy px-4 py-6 md:flex">
        ...
        <div className="mt-auto border-t border-white/10 pt-4">
          ...
          <form action={logoutAction}>
            <button
              type="submit"
              className="w-full rounded-xl px-3 py-2 text-left text-sm text-navy-300 transition hover:bg-white/5 hover:text-white"
            >
              Sign out
            </button>
          </form>
        ...
        <header className="flex items-center justify-between border-b border-line bg-surface px-6 py-4 md:px-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <form action={logoutAction}>
              <button
                type="submit"
                className="rounded-xl border border-line px-3 py-1.5 text-sm font-medium text-muted transition hover:bg-canvas hover:text-ink"
              >
                Sign out
              </button>
            </form>
